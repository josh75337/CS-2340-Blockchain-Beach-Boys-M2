...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Elijah Bailey");
        toPrint += p1.toString("ebailey38");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Matthew Chan");
        toPrint += p2.toString("mchan60");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Justin Weltner-Evans");
        toPrint += p3.toString("jtwe3");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Matthew Krupczak");
        toPrint += p4.toString("mkrupczak3");
        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Joshua Vayle");
        toPrint += p5.toString("jvayle3");
